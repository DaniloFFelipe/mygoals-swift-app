...
struct MaskedInput<Left: View>: View {
    ...
    var maskText: String {
        ...
        return formatter.string(for: text) ?? text
    }
...
extension MaskedInput where Left == EmptyView {
...
#Preview {
    ZStack {
        ...
        MaskedInput(text: .constant(""), placeholder: "Placeholder") {
            Image(systemName: "at")
        }
    }
}
